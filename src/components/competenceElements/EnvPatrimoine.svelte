...
<section class="text-section">
  ...
  <div class="article-body">
    <p><strong>Environnement et patrimoine naturel : Qui fait quoi à Putanges-le-Lac ?</strong></p>

    <h3>1. Contexte de Putanges-le-Lac</h3>
    <h4>Atouts naturels :</h4>
    <ul>
      <li><strong>Lac de Rabodanges</strong> : Site touristique majeur et réservoir de biodiversité.</li>
      <li><strong>Bocage et chemins creux</strong> : Patrimoine paysager et écologique unique.</li>
      <li><strong>Zones humides et forêts</strong> : Habitats pour la faune et la flore.</li>
    </ul>
