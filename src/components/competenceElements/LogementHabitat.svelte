...
<section class="text-section">
  ...
  <div class="article-body">
    <p><strong>Logement et habitat : Qui fait quoi à Putanges-le-Lac ?</strong></p>

    <h3>1. Contexte de Putanges-le-Lac</h3>
    <h4>Enjeux locaux :</h4>
    <ul>
      <li><strong>Logements vacants</strong> : Maisons trop grandes, difficulté à se loger malgré la vacance.</li>
      <li><strong>Manque de logements adaptés</strong> : Peu de logements sociaux ou adaptés aux personnes âgées.</li>
      <li><strong>Précarité énergétique</strong> : Parc ancien mal isolé.</li>
    </ul>
    <h4>Opportunités :</h4>
    <ul>
      <li>Réhabiliter les logements vacants pour créer des habitats adaptés.</li>
      <li>Zonage France Ruralités Revitalisation (FRR) : mobiliser des aides à la rénovation.</li>
    </ul>
    ...
    <p><strong>Exemple</strong> : fonds intercommunal pour la rénovation des propriétaires.</p>
  </div>
</section>
